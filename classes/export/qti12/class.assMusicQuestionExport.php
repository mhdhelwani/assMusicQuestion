...
/**
* Music question export
*
* @author Christoph Jobst <christoph.jobst@llz.uni-halle.de>
* @version	$Id:  $
* @ingroup ModulesTestQuestionPool
*/
class assMusicQuestionExport extends assQuestionExport
{
	/**
	...
	*/
	function toXML($a_include_header = true, $a_include_binary = true, $a_shuffle = false, $test_output = false, $force_image_references = false)
	{
		...
		//Question specific
		$a_xml_writer->xmlStartTag("keys_value");
		$a_xml_writer->xmlElement("fieldlabel", NULL, "keys_value");
		$a_xml_writer->xmlElement("fieldentry", NULL, $this->object->getKeysValue());
		$a_xml_writer->xmlEndTag("qtimetadatafield");
